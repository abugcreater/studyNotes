...
原因是：已知JDK 8附带的HotSpot JVM的早期版本存在一些问题，当启用G1GC收集器时，这些问题可能导致索引损坏。受影响的版本早于JDK 8u40随附的HotSpot版本。来源于[官方说明  (opens new window)](https://www.elastic.co/guide/en/elasticsearch/reference/current/_g1gc_check.html)
...
参考:[ES详解 - 优化：ElasticSearch性能优化详解](https://pdai.tech/md/db/nosql-es/elasticsearch-y-peformance.html)

//todo https://blog.csdn.net/a745233700/article/details/115585342